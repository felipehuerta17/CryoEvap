...
a_array_surface = jnp.linspace(0.01, 3.0, 100)
...
filename_surface = os.path.join(folder, 'LAES_opti_12h_LFs_ru_4.csv')
...
filename_opts = os.path.join(folder, 'LAES_opti_12h_LFs_ru_4_opts.csv')
