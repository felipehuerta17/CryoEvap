...
class Opti:
    ...
    def __init__(self, Tank_obj, time = 720, dz = 0.1, thickness = 0.02, x0 = 1, bounds = [0.1, 5]):
        ...
        self.initial_LF = Tank_obj.LF               # Store the initial LF to prevent state mutation during optimization
        ...
        required_attrs = ['U_L', 'U_V', 'Q_roof', 'T_air', 'eta_w']
    ...
    def __ofunction_BOR(self, a):
        ...
        # Reset liquid filling to prevent state drift between optimization iterations
        self.tank.LF = self.initial_LF
