...
# ax2.plot(data_LF50['Time'][mask_stationary_LF50]/3600, data_LF50['BOG'][mask_stationary_LF50]*3600, label='LF=0.50', color=cmap(1))
ax2.plot(data_LF95['Time'][mask_stationary_LF95]/3600, data_LF95['BOG'][mask_stationary_LF95]*3600, label='Wall model', color=cmap(2))
# ax2.plot(data_LF50_wo_wall['Time'][mask_stationary_LF50_wo_wall]/3600, data_LF50_wo_wall['BOG'][mask_stationary_LF50_wo_wall]*3600,'--', 
