...
tau_rq_08_LF95 = data['tau_rq_08_LF95']/3600
tau_rq_03_LF05 = data['tau_rq_03_LF05']/3600
tau_rq_08_LF05 = data['tau_rq_08_LF05']/3600

coef08_95 = np.polyfit(a_relation, tau_rq_08_LF95, 1)
coef03_95 = np.polyfit(a_relation, tau_rq_03_LF95, 1)
coef08_05 = np.polyfit(a_relation, tau_rq_08_LF05, 1)
coef03_05 = np.polyfit(a_relation, tau_rq_03_LF05, 1)

slope08_95 = coef08_95[0]
slope03_95 = coef03_95[0]
slope08_05 = coef08_05[0]
...
axs[0].plot(a, tau_rq_08_LF05, label=r'$r$ = 80%', color=paleta(2), linewidth=linewidth)
...
axs[1].plot(a, tau_rq_08_LF95, label=r'$r$ = 80%', color=paleta(2), linewidth=linewidth)
...
axs[0].text(0.83, 0.375, rf'$\tau \sim {slope03_05:.3f}\,a^{{-1/3}}$', transform=axs[0].transAxes,
            fontsize=14, ha='center', va='center', color=paleta(1))

axs[0].text(0.83, 0.13, rf'$\tau \sim {slope08_05:.3f}\,a^{{-1/3}}$', transform=axs[0].transAxes,
            fontsize=14, ha='center', va='center', color=paleta(2))

axs[1].text(0.83, 0.375, rf'$\tau \sim {slope03_95:.3f}\,a^{{-1/3}}$', transform=axs[1].transAxes,
            fontsize=14, ha='center', va='center', color=paleta(1))

axs[1].text(0.83, 0.13, rf'$\tau \sim {slope08_95:.3f}\,a^{{-1/3}}$', transform=axs[1].transAxes,
            fontsize=14, ha='center', va='center', color=paleta(2))
