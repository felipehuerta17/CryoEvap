...
folder = "Methane/"
data_30d_rq03 = pd.read_csv(folder+'Methane_opti_30d_LFs_rq03.csv')
optimos_30d_rq03 = pd.read_csv(folder+'Methane_opti_30d_LFs_rq03_opts.csv')
data_30d_rq07 = pd.read_csv(folder+'Methane_opti_30d_LFs_rq07.csv')
optimos_30d_rq07 = pd.read_csv(folder+'Methane_opti_30d_LFs_rq07_opts.csv')
...
plt.savefig("Figures/Fig_Methane_N1.svg", bbox_inches='tight', dpi=300)